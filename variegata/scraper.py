...
class Scraper:
    ...
    def insert_node(self, text):
        ...
        self.G.add_node(str(self.curr_story) + "_" + str(self.event_num), keywords=extract_keywords(text, 5), text=text)
...
def scrape_stories():
    ...
    for u in range(len(urls)):
        ...
        nx.write_gml(scraper.G, 'static/graphs/' + str(scraper.curr_story) + ".gml")
